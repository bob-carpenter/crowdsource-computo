...
All of the models were fit on the dentistry data using two chains of 1000 warmup and 1000 sampling draws each using the default settings of Stan.  All $\widehat{R}$ values were less than 1.01, indicating the draws are consistent with convergence.  
