---
title: "Bayesian Crowdsourcing for Items of Varying Difficulty"
subtitle: ""
author:
  - name: Bob Carpenter
    corresponding: true
...
description: |
abstract: >+
  Dawid and Skene's crowdsourcing model fails to capture important distributional properties of real rating data.  By adding a random effect for item difficulty, motivated by the item-response theory one-parameter logistic models (IRT-1PL), the dispersion of rating data can be captured.  This is illustrated with data from dental image classification and natural language inference.
